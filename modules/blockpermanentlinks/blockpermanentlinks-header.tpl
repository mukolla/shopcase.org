...
<ul id="header_links">
        ...
        <li id="header_link_sitemap"><a href="{$link->getPageLink('deliveryinfo')|escape:'html'}" title="{l s='Оплата и доставка' mod='blockpermanentlinks'}">{l s='Оплата и доставка' mod='blockpermanentlinks'}</a></li>
        <li id="header_link_sitemap"><a href="{$link->getPageLink('deliveryinfo')|escape:'html'}" title="{l s='О магазине' mod='blockpermanentlinks'}">{l s='О магазине' mod='blockpermanentlinks'}</a></li>
